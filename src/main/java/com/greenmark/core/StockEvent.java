...
//		}
    ...
    public final String toXml() {
        ...
        String stb = prefix + TAB + TAB + "<STOCK_EVENT>" + endline +
                prefix + TAB + TAB + TAB + "<ID>" + this.id + "</ID>" + endline +
                prefix + TAB + TAB + TAB + "<POSITION_ID>" + this.positionId + "</POSITION_ID>" + endline +
                prefix + TAB + TAB + TAB + "<EVENT_TYPE>" + this.type + "</EVENT_TYPE>" + endline +
                prefix + TAB + TAB + TAB + "<FROM_TIMEFRAME>" + this.fromTimeframe + "</FROM_TIMEFRAME>" + endline +
                prefix + TAB + TAB + TAB + "<TO_TIMEFRAME>" + this.toTimeframe + "</TO_TIMEFRAME>" + endline +
                prefix + TAB + TAB + TAB + "<THRESHOLD_STOCH_K>" + this.thresholdStochK + "</THRESHOLD_STOCH_K>" + endline +
                prefix + TAB + TAB + TAB + "<STOCH_K>" + this.stochK + "</STOCH_K>" + endline +
                prefix + TAB + TAB + TAB + "<MACD>" + this.macD + "</MACD>" + endline +
                prefix + TAB + TAB + TAB + "<RSI_CLASSIC>" + this.rsiClassic + "</RSI_CLASSIC>" + endline +
                prefix + TAB + TAB + TAB + "<EMA5>" + this.ema5 + "</EMA5>" + endline +
                prefix + TAB + TAB + TAB + "<EMA20>" + this.ema20 + "</EMA20>" + endline +
                prefix + TAB + TAB + TAB + "<PRICE>" + this.price + "</PRICE>" + endline +
                prefix + TAB + TAB + TAB + "<NUM_SHARES>" + this.numShares + "</NUM_SHARES>" + endline +

//System.out.println ("In StockEvent.toXml   this.datetime: [" + UTDisplayFormatter.formatDateAndTime( this.datetime ) + "]");

                prefix + TAB + TAB + TAB + "<DATETIME>" + thisDatetime.formatXMLDateTime(true) + "</DATETIME>" + endline +

//System.out.println ("In StockEvent.toXml   thisDatetime.formatXMLDateTime: [" + thisDatetime.formatXMLDateTime(true) + "]");

                prefix + TAB + TAB + TAB + "<DESCRIPTION>" + this.description + "</DESCRIPTION>" + endline +
                prefix + TAB + TAB + TAB + "<ACTIVE>" + this.getActive() + "</ACTIVE>" + endline +
                prefix + TAB + TAB + "</STOCK_EVENT>" + endline;
    ...
    public final boolean equals(Object _other) {
        ...
        if (!(_other instanceof StockEvent _cast))
            return false;
        ...
        return datetime.toString().equals(_cast.datetime.toString());
    }
