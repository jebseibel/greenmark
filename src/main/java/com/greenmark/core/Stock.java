...
public class Stock
{
   ...
   protected String symbol; /** The standardized stock symbol */
   protected String name; /** The name of the stock's company */

   protected NumberFormat nf = NumberFormat.getCurrencyInstance(); // For toString() formatting function.
   protected String market; /** The standardized market symbol */
   ...
   public static final int NUM_PTS_STOCH_SLOW_D = 5;
	...
	private boolean hasStockEvents = false;
   ...
   private LocalDateTime rejectedDatetime;
	...
	private int              rejectedAgingNumDays = 1;
