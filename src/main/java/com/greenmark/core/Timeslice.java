 ...
 * <h3>Timeslice</h3><p>
 *
 * This class is responsible for processing all timeslice data for a stock.
 * Its main goal is to act as the center point for retrieving and processing
 * data.<p>
 *
 * As development progresses, more data manipulating methods will be added so
 * that this object will be able to return any data required by the Watchers
 * and other objects as it relates to a stock's timeslices.<p>
 *
 * @author Jeb Seibel
 * @version 1.0
 */
public class Timeslice
{
	...
	/** The label constant for a stock  timeslice's open price */
	public static final String OPEN = "open";

	/** The label constant for a stock  timeslice's high price */
	public static final String HIGH = "high";

	/** The label constant for a stock  timeslice's low price */
	public static final String LOW = "low";

	/** The label constant for a stock  timeslice's close price */
...
////////////////////////////////////////////////////////////////////////////////
	...
	/**
	 * Creates a new instance of a timeslice.  This constructor is as simple
	 * as it gets.  There is no pre-processing of any values.
	 * @param data
	 */
...
//			String date = datetime.substring(datetime.lastIndexOf(" ", 12) + 1, datetime.length() );
			return( datetime.substring(datetime.lastIndexOf(" ", 12) + 1, datetime.length() ) );
		}
	...
	public final String getTimeHour()
	{
		...
		if( this.data.containsKey( DATE ) )
		{
			String datetime = (String) this.data.get( DATE );
//			int spacePosition = datetime.lastIndexOf(" ", 12);
			String time = datetime.substring(datetime.lastIndexOf(" ", 12) + 1, datetime.length() );
...
//			String date = datetime.substring(0,datetime.lastIndexOf(" ", 12));
	...
	public String toString()
	{
		...
		return( "Stock Timeslice: " + " datetime: " + date +
