...
//  }
  ...
  public static boolean isGuiOn ()
  {
	  ...
	  if ( historicalGuiModeType.equals(CONFIG_HISTORICAL_GUI_ON) )
		  return true;
	  else
		  return false;
  }
  ...
  public static boolean isGuiOff ()
  {
	  ...
	  if ( historicalGuiModeType.equals(CONFIG_HISTORICAL_GUI_OFF) )
		  return true;
	  else
		  return false;
  }
  ...
  public static boolean isGuiDailyReportOnly()
  {
	  ...
	  if (historicalGuiModeType.equals(CONFIG_HISTORICAL_GUI_SUMMARY_ONLY))
		  return true;
	  else
		  return false;
  }
