    ...
    public float calcPositionBalances (float newPrice, int numShares)
	 {
		 ...
		 try
		 {
			 ...
			 if (isTrue)
			 {
				 ...
				 float percentGrowth = (float) (newPrice - getBuyExecutedPrice()) /
					 (float) getBuyExecutedPrice();
				 // Now turn decimal into a percentage
				 percentGrowth *= 100;
				 setPercentGrowth(percentGrowth);

				 float totalGrowthAmt = (float) (newPrice - getBuyExecutedPrice()) *
...
//			outString.append( " " );
   ...
   //////////////////   BUY ORDER LIST CONVENIENCE FUNCTIONS
	public int getNumBuyOrders()   {      return numBuyOrders;   }
	public void setNumBuyOrders(int numBuyOrders)   {      this.numBuyOrders = numBuyOrders;   }

   public Hashtable getBuyOrderList()   {      return buyOrderList;   }
   ...
   public int getNumSellOrders()   {      return numSellOrders;   }
   public void setNumSellOrders(int numSellOrders)   {      this.numSellOrders = numSellOrders;   }

   public Hashtable getSellOrderList()   {      return sellOrderList;   }
...
//      }
   ...
   return reasons.toString();
	...
	public void setBuyExecutedNumShares( int executedNumShares )   {      this.buyExecutedNumShares = executedNumShares;   }
	public int getBuyExecutedNumShares()   {      return buyExecutedNumShares;   }

	public float getBuyExecutedPrice()   {      return buyExecutedPrice;   }
	public float getPainPrice()   {      return painPrice;   }

	public float getPercentGrowth()   {      return percentGrowth;   }
	public void setPercentGrowth( float percentGrowth )   {      this.percentGrowth = percentGrowth;   }

	public void setPainPrice( float painPrice )   {      this.painPrice = painPrice;   }
	public void setBuyExecutedPrice( float executedPrice )   {      this.buyExecutedPrice = executedPrice;   }
  ...
  public int getSellExecutedNumShares() {    return sellExecutedNumShares;  }
  public void setSellExecutedNumShares(int sellExecutedNumShares) {    this.sellExecutedNumShares = sellExecutedNumShares;  }

  public float getSellExecutedPrice() {    return sellExecutedPrice;  }
  public void setSellExecutedPrice(float sellExecutedPrice) {    this.sellExecutedPrice = sellExecutedPrice;  }

  public float getTotalGrowthAmount() {    return totalGrowthAmount;  }
  public void setTotalGrowthAmount(float totalGrowthAmt) {    this.totalGrowthAmount = totalGrowthAmt;  }
   ...
   public String getStockSymbol()
   {
	...
	{
		if (positionPainedOutNormal == 1)
			positionPainedOutNormally = true;
		else
			positionPainedOutNormally = false;
   }
