...
public class ConfigUtils {
	...
	public static boolean isGuiOn() {
		...
		if (historicalGuiModeType.equals(ConfigApplication.CONFIG_HISTORICAL_GUI_ON))
			return true;
		else
			return false;
	}
	...
	public static boolean isGuiOff() {
		...
		if (historicalGuiModeType.equals(ConfigApplication.CONFIG_HISTORICAL_GUI_OFF))
			return true;
		else
			return false;
	}
