...
public class BucketStrategyConfigDto implements Serializable {
    ...
    public String toXmlWrapper(String prefix, String endline) {
        String stb = prefix + "<BUCKET_STRATEGY_CONFIG>" + endline +
                prefix + toXml(prefix, endline) + endline +
                prefix + "</BUCKET_STRATEGY_CONFIG>" + endline;
        return stb;
    }
    ...
    public String toXml(String prefix, String endline) {
        ...
        String stb = prefix + "<ID>" + this.id + "</ID>" + endline +
                ...
                prefix + UTDisplayFormatter.TAB + "<STOCK_EVENT_ID>" + this.stockEventId + "</STOCK_EVENT_ID>" + endline +
                prefix + UTDisplayFormatter.TAB + "<CURRENT_STATE>" + this.currentState + "</CURRENT_STATE>" + endline +
                prefix + UTDisplayFormatter.TAB + "<USE_MOMENTUM>" + this.isUseMomentum() + "</USE_MOMENTUM>" + endline +
                prefix + UTDisplayFormatter.TAB + "<MOMENTUM_TYPE>" + this.getMomentumType().getIdString() + "</MOMENTUM_TYPE>" + endline +
                prefix + UTDisplayFormatter.TAB + "<THRESHOLD_MOMENTUM>" + this.getThresholdMomentum() + "</THRESHOLD_MOMENTUM>" + endline +
                prefix + UTDisplayFormatter.TAB + "<USE_MACD_NUM_PERIODS>" + this.isUseMacdNumPeriods() + "</USE_MACD_NUM_PERIODS>" + endline +
                prefix + UTDisplayFormatter.TAB + "<THRESHOLD_MACD_NUM_PERIODS>" + this.getThresholdMacdNumPeriods() + "</THRESHOLD_MACD_NUM_PERIODS>" + endline +
                prefix + UTDisplayFormatter.TAB + "<USE_MACD_SIGNAL>" + this.isUseMacdSignal() + "</USE_MACD_SIGNAL>" + endline +
                prefix + UTDisplayFormatter.TAB + "<USE_834_STRATEGY>" + this.isUse_834_Strategy() + "</USE_834_STRATEGY>" + endline +
                prefix + UTDisplayFormatter.TAB + "<STRATEGY_834_STATE>" + this.strategy_834_State + "</STRATEGY_834_STATE>" + endline +
                prefix + UTDisplayFormatter.TAB + "<STRATEGY_834_STOPLOSS_STATE>" + this.strategy_834_StopLossState + "</STRATEGY_834_STOPLOSS_STATE>" + endline +
                prefix + UTDisplayFormatter.TAB + "<WHEN_BOUGHT_8EMA>" + this.whenBought8ema + "</WHEN_BOUGHT_8EMA>" + endline +
                prefix + UTDisplayFormatter.TAB + "<WHEN_BOUGHT_20SMA>" + this.whenBought20sma + "</WHEN_BOUGHT_20SMA>" + endline +
                prefix + UTDisplayFormatter.TAB + "<THRESHOLD_NUM_PERIODS_SINCE_SOLD>" + this.getNumPeriodsSinceSoldThreshold() + "</THRESHOLD_NUM_PERIODS_SINCE_SOLD>" + endline +
                prefix + UTDisplayFormatter.TAB + "<THRESHOLD_NUM_PERIODS_SINCE_OVER34>" + this.getNumPeriodsSinceOver34Threshold() + "</THRESHOLD_NUM_PERIODS_SINCE_OVER34>" + endline +
                prefix + UTDisplayFormatter.TAB + "<THRESHOLD_8EMA>" + this.getEma8Threshold() + "</THRESHOLD_8EMA>" + endline +
                prefix + UTDisplayFormatter.TAB + "<THRESHOLD_14SMA>" + this.getSma14Threshold() + "</THRESHOLD_14SMA>" + endline +
                prefix + UTDisplayFormatter.TAB + "<THRESHOLD_20SMA>" + this.getSma20Threshold() + "</THRESHOLD_20SMA>" + endline +
                prefix + UTDisplayFormatter.TAB + "<THRESHOLD_34EMA>" + this.getEma34Threshold() + "</THRESHOLD_34EMA>" + endline +
                prefix + UTDisplayFormatter.TAB + "<THRESHOLD_20SMA_STOPLOSS>" + this.getSma20StopLossThreshold() + "</THRESHOLD_20SMA_STOPLOSS>" + endline +
                prefix + UTDisplayFormatter.TAB + "<THRESHOLD_34EMA_STOPLOSS>" + this.getEma34StopLossThreshold() + "</THRESHOLD_34EMA_STOPLOSS>" + endline +
                prefix + UTDisplayFormatter.TAB + "<ON_ENTRY_ORDER_PERCENT>" + this.getOnEntryOrderPercent() + "</ON_ENTRY_ORDER_PERCENT>" + endline +
                prefix + UTDisplayFormatter.TAB + "<ON_CONFIRM_ORDER_PERCENT>" + this.getOnConfirmOrderPercent() + "</ON_CONFIRM_ORDER_PERCENT>" + endline +
                prefix + UTDisplayFormatter.TAB + "<FILTER_INTRADAY_SPIKES>" + this.filterIntradaySpikes + "</FILTER_INTRADAY_SPIKES>" + endline;
        return stb;
    }
