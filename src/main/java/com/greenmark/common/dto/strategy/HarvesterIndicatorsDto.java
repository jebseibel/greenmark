...
public class HarvesterIndicatorsDto implements Serializable {
	...
	public String toXmlWrapper(String prefix, String endline) {
		...
		stb.append(prefix + "<HARVESTER_INDICATORS>" + endline);
	...
	public String toXml(String prefix, String endline) {
		...
		stb.append(prefix + UTDisplayFormatter.TAB + "<POSITION_EVENT_ID>" + this.positionEventId + "</POSITION_EVENT_ID>" + endline);

		stb.append(prefix + UTDisplayFormatter.TAB + "<LONG_8_OVER_14>" + this.long8over14 + "</LONG_8_OVER_14>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<LONG_8_OVER_14_8EMA>" + this.long8over14_8ema + "</LONG_8_OVER_14_8EMA>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<LONG_8_OVER_14_14SMA>" + this.long8over14_14sma + "</LONG_8_OVER_14_14SMA>" + endline);

		stb.append(prefix + UTDisplayFormatter.TAB + "<LONG_8_OVER_34>" + this.long8over34 + "</LONG_8_OVER_34>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<LONG_8_OVER_34_8EMA>" + this.long8over34_8ema + "</LONG_8_OVER_34_8EMA>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<LONG_8_OVER_34_34EMA>" + this.long8over34_34ema + "</LONG_8_OVER_34_34EMA>" + endline);

		stb.append(prefix + UTDisplayFormatter.TAB + "<LONG_PRICE_OVER_34>" + this.longPriceOver34 + "</LONG_PRICE_OVER_34>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<LONG_PRICE_OVER_34_34EMA>" + this.longPriceOver34_34ema + "</LONG_PRICE_OVER_34_34EMA>" + endline);

		stb.append(prefix + UTDisplayFormatter.TAB + "<LONG_PRICE_CONFIRMED>" + this.longPriceConfirmed + "</LONG_PRICE_CONFIRMED>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<LONG_MAS_ALIGNED>" + this.longMovingAveragesAligned + "</LONG_MAS_ALIGNED>" + endline);

		stb.append(prefix + UTDisplayFormatter.TAB + "<LONG_OVER_200>" + this.longOver200 + "</LONG_OVER_200>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<LONG_OVER_200_200SMA>" + this.longOver200_200sma + "</LONG_OVER_200_200SMA>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<LONG_RISING_200>" + this.longRising200 + "</LONG_RISING_200>" + endline);

		stb.append(prefix + UTDisplayFormatter.TAB + "<LONG_OVER_50>" + this.longOver50 + "</LONG_OVER_50>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<LONG_OVER_50_50SMA>" + this.longOver50_50sma + "</LONG_OVER_50_50SMA>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<LONG_RISING_50>" + this.longRising50 + "</LONG_RISING_50>" + endline);

		stb.append(prefix + UTDisplayFormatter.TAB + "<LONG_USD_USDT_ONLY>" + this.longUsdUsdtOnly + "</LONG_USD_USDT_ONLY>" + endline);

		stb.append(prefix + UTDisplayFormatter.TAB + "<SHORT_8_UNDER_14>" + this.short8under14 + "</SHORT_8_UNDER_14>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<SHORT_8_UNDER_14_8EMA>" + this.short8under14_8ema + "</SHORT_8_UNDER_14_8EMA>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<SHORT_8_UNDER_14_14SMA>" + this.short8under14_14sma + "</SHORT_8_UNDER_14_14SMA>" + endline);

		stb.append(prefix + UTDisplayFormatter.TAB + "<SHORT_8_UNDER_34>" + this.short8under34 + "</SHORT_8_UNDER_34>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<SHORT_8_UNDER_34_8EMA>" + this.short8under34_8ema + "</SHORT_8_UNDER_34_8EMA>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<SHORT_8_UNDER_34_34EMA>" + this.short8under34_34ema + "</SHORT_8_UNDER_34_34EMA>" + endline);

		stb.append(prefix + UTDisplayFormatter.TAB + "<SHORT_PRICE_UNDER_34>" + this.shortPriceUnder34 + "</SHORT_PRICE_UNDER_34>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<SHORT_PRICE_UNDER_34_34EMA>" + this.shortPriceUnder34_34ema + "</SHORT_PRICE_UNDER_34_34EMA>" + endline);

		stb.append(prefix + UTDisplayFormatter.TAB + "<SHORT_PRICE_CONFIRMED>" + this.shortPriceConfirmed + "</SHORT_PRICE_CONFIRMED>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<SHORT_MAS_ALIGNED>" + this.shortMovingAveragesAligned + "</SHORT_MAS_ALIGNED>" + endline);

		stb.append(prefix + UTDisplayFormatter.TAB + "<SHORT_UNDER_200>" + this.shortUnder200 + "</SHORT_UNDER_200>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<SHORT_UNDER_200_200SMA>" + this.shortUnder200_200sma + "</SHORT_UNDER_200_200SMA>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<SHORT_FALLING_200>" + this.shortFalling200 + "</SHORT_FALLING_200>" + endline);

		stb.append(prefix + UTDisplayFormatter.TAB + "<SHORT_UNDER_50>" + this.shortUnder50 + "</SHORT_UNDER_50>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<SHORT_UNDER_50_50SMA>" + this.shortUnder50_50sma + "</SHORT_UNDER_50_50SMA>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<SHORT_FALLING_50>" + this.shortFalling50 + "</SHORT_FALLING_50>" + endline);

		stb.append(prefix + UTDisplayFormatter.TAB + "<SHORT_USD_USDT_ONLY>" + this.shortUsdUsdtOnly + "</SHORT_USD_USDT_ONLY>" + endline);
