...
public class DropcatDto implements Serializable {
    ...
    public DropcatDto(String xmldata) {
        ...
        try {
            ...
            sellPlacedEndOfDay = !sellPlacedEndOfDayStr.equals("false");

            String painedOutPositionStr = UTXmlUtils.getXmlData(xmldata, "PAINED_OUT_POSITION");
            painedOutPosition = !painedOutPositionStr.equals("false");
            ...
            doubledDown = !doubledDownStr.equals("false");
    ...
    public String toXml(String prefix, String endline) {
        ...
        String stb = prefix + "<DROPCAT_INFO>" + endline +
                prefix + UTDisplayFormatter.TAB + "<ID>" + this.id + "</ID>" + endline +
                prefix + UTDisplayFormatter.TAB + "<POSITION_ID>" + positionId + "</POSITION_ID>" + endline +
                prefix + UTDisplayFormatter.TAB + "<TRAPPED_DATE>" + formattedTrappedDatetime + "</TRAPPED_DATE>" + endline +
                prefix + UTDisplayFormatter.TAB + "<TRAP_PERCENT_LOSS>" + trapPercentLoss + "</TRAP_PERCENT_LOSS>" + endline +
                prefix + UTDisplayFormatter.TAB + "<TRAP_PERCENT_LOSS_THRESH>" + trapPercentLossThreshold + "</TRAP_PERCENT_LOSS_THRESH>" + endline +
                prefix + UTDisplayFormatter.TAB + "<TRAP_PRICE>" + trapPrice + "</TRAP_PRICE>" + endline +
                prefix + UTDisplayFormatter.TAB + "<ADDTL_PAIN_PRICE>" + additionalPainPrice + "</ADDTL_PAIN_PRICE>" + endline +
                prefix + UTDisplayFormatter.TAB + "<ADDTL_PAIN_PRICE_THRESH>" + additionalPainPriceThreshold + "</ADDTL_PAIN_PRICE_THRESH>" + endline +
                prefix + UTDisplayFormatter.TAB + "<EXITMIN15_STOCHK>" + exitMin15Stochk + "</EXITMIN15_STOCHK>" + endline +
                prefix + UTDisplayFormatter.TAB + "<EXITMIN15_STOCHK_THRESH>" + exitMin15StochkThreshold + "</EXITMIN15_STOCHK_THRESH>" + endline +
                prefix + UTDisplayFormatter.TAB + "<EXITMIN15_DATE>" + formattedExitMin15Datetime + "</EXITMIN15_DATE>" + endline +
                prefix + UTDisplayFormatter.TAB + "<SELLPLACED_MIN5_STOCHK>" + sellPlacedMin5Stochk + "</SELLPLACED_MIN5_STOCHK>" + endline +
                prefix + UTDisplayFormatter.TAB + "<SELLPLACED_MIN5_STOCHK_THRESH>" + sellPlacedMin5StochkThreshold + "</SELLPLACED_MIN5_STOCHK_THRESH>" + endline +
                prefix + UTDisplayFormatter.TAB + "<SELLPLACED_DATE>" + formattedSellDate + "</SELLPLACED_DATE>" + endline +
                prefix + UTDisplayFormatter.TAB + "<SELLPLACED_SELL_PRICE>" + sellPlacedSellPrice + "</SELLPLACED_SELL_PRICE>" + endline +
                prefix + UTDisplayFormatter.TAB + "<SELLPLACED_CURRENT_PRICE>" + sellPlacedCurrentPrice + "</SELLPLACED_CURRENT_PRICE>" + endline +
                prefix + UTDisplayFormatter.TAB + "<SELLPLACED_END_OF_DAY>" + sellPlacedEndOfDay + "</SELLPLACED_END_OF_DAY>" + endline +
                prefix + UTDisplayFormatter.TAB + "<PAINED_OUT_POSITION>" + painedOutPosition + "</PAINED_OUT_POSITION>" + endline +
                prefix + UTDisplayFormatter.TAB + "<SELLEXECUTED_DATE>" + formattedSellExecutedDatetime + "</SELLEXECUTED_DATE>" + endline +
                prefix + UTDisplayFormatter.TAB + "<SELLEXECUTED_PRICE>" + sellExecutedPrice + "</SELLEXECUTED_PRICE>" + endline +
                prefix + UTDisplayFormatter.TAB + "<DOUBLED_DOWN>" + doubledDown + "</DOUBLED_DOWN>" + endline +
                prefix + UTDisplayFormatter.TAB + "<DOUBLEDOWN_BUY_DATETIME>" + formattedDoubleDownBuyDatetime + "</DOUBLEDOWN_BUY_DATETIME>" + endline +
                prefix + UTDisplayFormatter.TAB + "<DOUBLEDOWN_BUY_PRICE>" + doubleDownBuyPrice + "</DOUBLEDOWN_BUY_PRICE>" + endline +
                prefix + UTDisplayFormatter.TAB + "<DOUBLEDOWN_MIN5_STOCHK>" + doubleDownMin5Stochk + "</DOUBLEDOWN_MIN5_STOCHK>" + endline +
                prefix + UTDisplayFormatter.TAB + "<DROPCAT_STATUS>" + dropcatStatus + "</DROPCAT_STATUS>" + endline +
                prefix + "</DROPCAT_INFO>" + endline;
        return stb;
    }
