...
public class SecurityJTableParams implements Serializable {
    ...
    public String toXmlWrapper(String prefix, String endline) {
        String stb = prefix + "<SECURITY_JTABLE_PARAMETERS>" + endline +
                prefix + toXml(prefix, endline) + endline +
                prefix + "</SECURITY_JTABLE_PARAMETERS>" + endline;
        return stb;
    }

    public String toXml(String prefix, String endline) {

        String stb = prefix + UTDisplayFormatter.TAB + "<USE_834_STRATEGY>" + this.use_834_Strategy + "</USE_834_STRATEGY>" + endline +
                prefix + UTDisplayFormatter.TAB + "<BUCKET_STRATEGY_LABEL>" + this.bucketStrategyLabel + "</BUCKET_STRATEGY_LABEL>" + endline +
                prefix + UTDisplayFormatter.TAB + "<STRATEGY_834_STOPLOSS_LABEL>" + this.strategy834_StopLossLabel + "</STRATEGY_834_STOPLOSS_LABEL>" + endline +
                prefix + UTDisplayFormatter.TAB + "<HARVEST_STRATEGY_LABEL>" + this.harvestStrategyLabel + "</HARVEST_STRATEGY_LABEL>" + endline;
