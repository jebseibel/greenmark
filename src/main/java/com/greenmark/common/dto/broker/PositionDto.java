...
public class PositionDto implements Comparator, Serializable {
	...
	public String toXml(String prefix, String endline) {
		...
		stb.append(prefix + UTDisplayFormatter.TAB + "<SECURITY_ID>" + this.securityId + "</SECURITY_ID>" + endline);

		stb.append(prefix + UTDisplayFormatter.TAB + "<LONG_OR_SHORT>" + this.longOrShort + "</LONG_OR_SHORT>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<POSITION_PHASE>" + this.positionPhase + "</POSITION_PHASE>" + endline);

		stb.append(prefix + UTDisplayFormatter.TAB + "<POSITION_STATUS>" + positionStatus + "</POSITION_STATUS>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<HARVEST_STRATEGY_TYPE_ID>" + harvestStrategyTypeId + "</HARVEST_STRATEGY_TYPE_ID>" + endline);

		stb.append(prefix + UTDisplayFormatter.TAB + "<STOCK_STRATEGY_ID>" + bucketStrategyStateId + "</STOCK_STRATEGY_ID>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<ORIGIN_BUCKET_TIMEFRAME>" + originBucketTimeframe + "</ORIGIN_BUCKET_TIMEFRAME>" + endline);

		stb.append(prefix + UTDisplayFormatter.TAB + "<DROPCAT_PAIN_PRICE>" + dropcatPainPrice + "</DROPCAT_PAIN_PRICE>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<BUY_EXECUTED_PRICE>" + buyExecutedPrice + "</BUY_EXECUTED_PRICE>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<BUY_ENTRY_PRICE>" + buyEntryPrice + "</BUY_ENTRY_PRICE>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<BUY_EXECUTED_NUM_SHARES>" + buyExecutedNumShares + "</BUY_EXECUTED_NUM_SHARES>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<BUY_EXECUTED_DATE>" + formattedDate + "</BUY_EXECUTED_DATE>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<SELL_EXECUTED_PRICE>" + sellExecutedPrice + "</SELL_EXECUTED_PRICE>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<SELL_ENTRY_PRICE>" + sellEntryPrice + "</SELL_ENTRY_PRICE>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<SELL_EXECUTED_NUM_SHARES>" + sellExecutedNumShares + "</SELL_EXECUTED_NUM_SHARES>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<SELL_EXECUTED_DATE>" + formattedSellDate + "</SELL_EXECUTED_DATE>" + endline);

		stb.append(prefix + UTDisplayFormatter.TAB + "<PAIN_PRICE>" + painPrice + "</PAIN_PRICE>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<PERCENT_GROWTH_PRICES>" + percentGrowthPrices + "</PERCENT_GROWTH_PRICES>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<PERCENT_GROWTH>" + percentGrowth + "</PERCENT_GROWTH>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<TOTAL_GROWTH_PRICES_AMT>" + totalGrowthPricesAmount + "</TOTAL_GROWTH_PRICES_AMT>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<TOTAL_GROWTH_AMT>" + totalGrowthAmount + "</TOTAL_GROWTH_AMT>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<NUM_PROFIT_TAKE_ORDERS>" + numProfitTakeOrders + "</NUM_PROFIT_TAKE_ORDERS>" + endline);
		stb.append(prefix + UTDisplayFormatter.TAB + "<USER_NOTES>" + userNotes + "</USER_NOTES>" + endline);
