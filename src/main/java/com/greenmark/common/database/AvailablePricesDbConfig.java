...
public final class AvailablePricesDbConfig extends DbConfigBase implements Serializable {
    ...
    public String toXml(String prefix, String endline) {
        String stb = prefix + "<PRICES_DB>" + endline +
                prefix + UTDisplayFormatter.TAB + "<PDB_NAME>" + this.getDatabaseName() + "</PDB_NAME>" + endline +
                prefix + UTDisplayFormatter.TAB + "<PDB_CONNECTION_URL>" + this.getDatabaseConnectionUrl() + "</PDB_CONNECTION_URL>" + endline +
                prefix + UTDisplayFormatter.TAB + "<PDB_CONNECTION_USERNAME>" + this.getDatabaseConnectionUsername() + "</PDB_CONNECTION_USERNAME>" + endline +
                prefix + UTDisplayFormatter.TAB + "<PDB_CONNECTION_PASSWORD>" + this.getDatabaseConnectionPassword() + "</PDB_CONNECTION_PASSWORD>" + endline +
