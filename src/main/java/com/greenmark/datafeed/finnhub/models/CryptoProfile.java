...
public class CryptoProfile {
  ...
  **/
  ...
  public String toString() {
      ...
      String sb = "class CryptoProfile {\n" +
              "    longName: " + toIndentedString(longName) + "\n" +
              "    name: " + toIndentedString(name) + "\n" +
              "    description: " + toIndentedString(description) + "\n" +
              "    website: " + toIndentedString(website) + "\n" +
              "    marketCap: " + toIndentedString(marketCap) + "\n" +
              "    totalSupply: " + toIndentedString(totalSupply) + "\n" +
              "    maxSupply: " + toIndentedString(maxSupply) + "\n" +
              "    circulatingSupply: " + toIndentedString(circulatingSupply) + "\n" +
              "    logo: " + toIndentedString(logo) + "\n" +
              "    launchDate: " + toIndentedString(launchDate) + "\n" +
              "    proofType: " + toIndentedString(proofType) + "\n" +
              "}";
    return sb;
  }
