...
public class SentimentContent {
    ...
    public String toString() {
        ...
        String sb = "class SentimentContent {\n" +
                "    mention: " + toIndentedString(mention) + "\n" +
                "    positiveMention: " + toIndentedString(positiveMention) + "\n" +
                "    negativeMention: " + toIndentedString(negativeMention) + "\n" +
                "    positiveScore: " + toIndentedString(positiveScore) + "\n" +
                "    negativeScore: " + toIndentedString(negativeScore) + "\n" +
                "    score: " + toIndentedString(score) + "\n" +
                "    atTime: " + toIndentedString(atTime) + "\n" +
                "}";
        return sb;
    }
