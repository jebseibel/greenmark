...
public class CompanyEarningsQualityScoreData {
    ...
    public String toString() {
        ...
        String sb = "class CompanyEarningsQualityScoreData {\n" +
                "    period: " + toIndentedString(period) + "\n" +
                "    growth: " + toIndentedString(growth) + "\n" +
                "    profitability: " + toIndentedString(profitability) + "\n" +
                "    cashGenerationCapitalAllocation: " + toIndentedString(cashGenerationCapitalAllocation) + "\n" +
                "    leverage: " + toIndentedString(leverage) + "\n" +
                "    score: " + toIndentedString(score) + "\n" +
                "    letterScore: " + toIndentedString(letterScore) + "\n" +
                "}";
        return sb;
    }
