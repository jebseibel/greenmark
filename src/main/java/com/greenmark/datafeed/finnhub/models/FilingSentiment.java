...
public class FilingSentiment {
    ...
    public String toString() {
        ...
        String sb = "class FilingSentiment {\n" +
                "    negative: " + toIndentedString(negative) + "\n" +
                "    positive: " + toIndentedString(positive) + "\n" +
                "    polarity: " + toIndentedString(polarity) + "\n" +
                "    litigious: " + toIndentedString(litigious) + "\n" +
                "    uncertainty: " + toIndentedString(uncertainty) + "\n" +
                "    constraining: " + toIndentedString(constraining) + "\n" +
                "    modalWeak: " + toIndentedString(modalWeak) + "\n" +
                "    modalStrong: " + toIndentedString(modalStrong) + "\n" +
                "    modalModerate: " + toIndentedString(modalModerate) + "\n" +
                "}";
        return sb;
    }
