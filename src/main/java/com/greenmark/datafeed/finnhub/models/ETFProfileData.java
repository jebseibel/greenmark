...
public class ETFProfileData {
    ...
    public String toString() {
        ...
        String sb = "class ETFProfileData {\n" +
                "    name: " + toIndentedString(name) + "\n" +
                "    assetClass: " + toIndentedString(assetClass) + "\n" +
                "    investmentSegment: " + toIndentedString(investmentSegment) + "\n" +
                "    aum: " + toIndentedString(aum) + "\n" +
                "    nav: " + toIndentedString(nav) + "\n" +
                "    navCurrency: " + toIndentedString(navCurrency) + "\n" +
                "    expenseRatio: " + toIndentedString(expenseRatio) + "\n" +
                "    trackingIndex: " + toIndentedString(trackingIndex) + "\n" +
                "    etfCompany: " + toIndentedString(etfCompany) + "\n" +
                ...
                "    priceToEarnings: " + toIndentedString(priceToEarnings) + "\n" +
                "    priceToBook: " + toIndentedString(priceToBook) + "\n" +
                "    avgVolume: " + toIndentedString(avgVolume) + "\n" +
                "    description: " + toIndentedString(description) + "\n" +
                "    isInverse: " + toIndentedString(isInverse) + "\n" +
                "    isLeveraged: " + toIndentedString(isLeveraged) + "\n" +
                "    leverageFactor: " + toIndentedString(leverageFactor) + "\n" +
                "}";
        return sb;
    }
