...
public class InstitutionalProfileInfo {
    ...
    public String toString() {
        ...
        String sb = "class InstitutionalProfileInfo {\n" +
                "    cik: " + toIndentedString(cik) + "\n" +
                "    firmType: " + toIndentedString(firmType) + "\n" +
                "    manager: " + toIndentedString(manager) + "\n" +
                "    philosophy: " + toIndentedString(philosophy) + "\n" +
                "    profile: " + toIndentedString(profile) + "\n" +
                "    profileImg: " + toIndentedString(profileImg) + "\n" +
                "}";
        return sb;
    }
