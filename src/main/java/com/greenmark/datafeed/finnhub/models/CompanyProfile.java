...
public class CompanyProfile {
    ...
    public String toString() {
        ...
        String sb = "class CompanyProfile {\n" +
                "    alias: " + toIndentedString(alias) + "\n" +
                "    address: " + toIndentedString(address) + "\n" +
                "    city: " + toIndentedString(city) + "\n" +
                "    country: " + toIndentedString(country) + "\n" +
                "    currency: " + toIndentedString(currency) + "\n" +
                "    estimateCurrency: " + toIndentedString(estimateCurrency) + "\n" +
                "    marketCapCurrency: " + toIndentedString(marketCapCurrency) + "\n" +
                "    cusip: " + toIndentedString(cusip) + "\n" +
                "    sedol: " + toIndentedString(sedol) + "\n" +
                "    description: " + toIndentedString(description) + "\n" +
                "    exchange: " + toIndentedString(exchange) + "\n" +
                "    ggroup: " + toIndentedString(ggroup) + "\n" +
                "    gind: " + toIndentedString(gind) + "\n" +
                "    gsector: " + toIndentedString(gsector) + "\n" +
                "    gsubind: " + toIndentedString(gsubind) + "\n" +
                "    isin: " + toIndentedString(isin) + "\n" +
                "    lei: " + toIndentedString(lei) + "\n" +
                "    naicsNationalIndustry: " + toIndentedString(naicsNationalIndustry) + "\n" +
                "    naics: " + toIndentedString(naics) + "\n" +
                "    naicsSector: " + toIndentedString(naicsSector) + "\n" +
                "    naicsSubsector: " + toIndentedString(naicsSubsector) + "\n" +
                "    name: " + toIndentedString(name) + "\n" +
                "    phone: " + toIndentedString(phone) + "\n" +
                "    state: " + toIndentedString(state) + "\n" +
                "    ticker: " + toIndentedString(ticker) + "\n" +
                "    weburl: " + toIndentedString(weburl) + "\n" +
                "    ipo: " + toIndentedString(ipo) + "\n" +
                "    marketCapitalization: " + toIndentedString(marketCapitalization) + "\n" +
                "    shareOutstanding: " + toIndentedString(shareOutstanding) + "\n" +
                "    employeeTotal: " + toIndentedString(employeeTotal) + "\n" +
                "    logo: " + toIndentedString(logo) + "\n" +
                "    finnhubIndustry: " + toIndentedString(finnhubIndustry) + "\n" +
                "}";
        return sb;
    }
