...
public class MutualFundProfileData {
    ...
    public String toString() {
        ...
        String sb = "class MutualFundProfileData {\n" +
                "    name: " + toIndentedString(name) + "\n" +
                "    category: " + toIndentedString(category) + "\n" +
                "    investmentSegment: " + toIndentedString(investmentSegment) + "\n" +
                "    totalNav: " + toIndentedString(totalNav) + "\n" +
                "    expenseRatio: " + toIndentedString(expenseRatio) + "\n" +
                "    benchmark: " + toIndentedString(benchmark) + "\n" +
                "    inceptionDate: " + toIndentedString(inceptionDate) + "\n" +
                "    description: " + toIndentedString(description) + "\n" +
                "    fundFamily: " + toIndentedString(fundFamily) + "\n" +
                "    fundCompany: " + toIndentedString(fundCompany) + "\n" +
                "    manager: " + toIndentedString(manager) + "\n" +
                "    status: " + toIndentedString(status) + "\n" +
                "    beta: " + toIndentedString(beta) + "\n" +
                "    deferredLoad: " + toIndentedString(deferredLoad) + "\n" +
                "    fee12b1: " + toIndentedString(fee12b1) + "\n" +
                "    frontLoad: " + toIndentedString(frontLoad) + "\n" +
                "    iraMinInvestment: " + toIndentedString(iraMinInvestment) + "\n" +
                "    isin: " + toIndentedString(isin) + "\n" +
                "    cusip: " + toIndentedString(cusip) + "\n" +
                "    maxRedemptionFee: " + toIndentedString(maxRedemptionFee) + "\n" +
                "    standardMinInvestment: " + toIndentedString(standardMinInvestment) + "\n" +
                "    turnover: " + toIndentedString(turnover) + "\n" +
                "    seriesId: " + toIndentedString(seriesId) + "\n" +
                "    seriesName: " + toIndentedString(seriesName) + "\n" +
                "    classId: " + toIndentedString(classId) + "\n" +
                "    className: " + toIndentedString(className) + "\n" +
                "    sfdrClassification: " + toIndentedString(sfdrClassification) + "\n" +
