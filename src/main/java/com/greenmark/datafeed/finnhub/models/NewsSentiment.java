...
public class NewsSentiment {
  ...
  **/
  ...
  public String toString() {
      ...
      String sb = "class NewsSentiment {\n" +
              "    buzz: " + toIndentedString(buzz) + "\n" +
              "    companyNewsScore: " + toIndentedString(companyNewsScore) + "\n" +
              "    sectorAverageBullishPercent: " + toIndentedString(sectorAverageBullishPercent) + "\n" +
              "    sectorAverageNewsScore: " + toIndentedString(sectorAverageNewsScore) + "\n" +
              "    sentiment: " + toIndentedString(sentiment) + "\n" +
