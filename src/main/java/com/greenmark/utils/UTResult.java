...
public class UTResult {
	 ...
	 *
	 * @param <code>successCode</code>Boolean
	 *            flag signifying operations success or failure
	 */
	 ...
	 * @param <code>successCode</code>Boolean
	 *            flag signifying operations success or failure
	 * @param <code>returnObject</code>An
	 ...
	 * @param <code>errorCode</code>A
	 *            String error number.
	 * @param <code>errorDescription</code>Human
	 *            readable error message (not for end user)
	 */
