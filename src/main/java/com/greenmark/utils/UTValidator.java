...
public class UTValidator {
	private static String CLASSNAME = "UTValidator";
	...
	public static UTResult validateString(String value) {
		return UTValidator.validateString(value, new String(""));
	}
	 ...
	 *            The error value returned on error.
	 */
	...
	public static UTResult validateNumber(String value) {
		return UTValidator.validateNumber(value, new String(""));
	}
	...
	public static UTResult validateCurrency(String value) {
		return UTValidator.validateCurrency(value, new String(""));
	}
	...
	public static UTResult validateInt(String value) {
		return UTValidator.validateInt(value, new String(""));
	}
	...
	public static UTResult validateYesNo(String value) {
		return UTValidator.validateYesNo(value, new String(""));
	}
	...
	public static UTResult validateDatetime(String value) {
		return UTValidator.validateDatetime(value, new String(""));
	}
	 ...
	 * @param <code>error</code>
	 *            The error to be returned on failure.
	 */
	...
	public static UTResult validateDate(String value) {
		return UTValidator.validateDate(value, new String(""));
	}
	...
	public static UTResult validateMSDate(String value) {
		return UTValidator.validateMSDate(value, new String(""));
	}
	...
	public static UTResult validateMSDate(String value, String error) {
		...
		try {
			...
			return UTValidator.validateDate(stb.toString(), new String(""));
		} catch (Exception e) {
	 ...
	 * @param <code>date</code>
	 *            The date to be checked.
	 * @param <code>error</code>The
	 *            error value returned on error.
	 */
	public static UTResult validateDate(String value, String error) {
		...
		Integer iday = new Integer(0);
		Integer imonth = new Integer(0);
		Integer iyear = new Integer(0);

		try {
			iday = new Integer(day);
			...
			if ((iday.intValue() < 1) || (iday.intValue() > 31)) {
				...
				String thisMon = new String();
				String thisDay = new String();
				...
				for (Enumeration e = MonthDays.keys(); e.hasMoreElements();) {
					...
					Integer intMon = new Integer(thisMon);
					Integer intDay = new Integer(thisDay);
	 ...
	 * 
	 * @param <code>value</code>
	 *            The value to be checked in.
	 */
	public static UTResult validateLongTime(String value) {
		return UTValidator.validateLongTime(value, new String(""));
	}
	...
	public static UTResult validateShortTime(String value) {
		return UTValidator.validateShortTime(value, new String(""));
	}
	 ...
	 * @param <code>min</code>
	 *            The minimum value as a long value.
	 * @param <code>max</code>
	 *            The maximum value as a long value.
	 */
	public static UTResult validateNumberSize(String value, String min, String max) {
		return UTValidator.validateNumberSize(value, min, max, new String(""));
	}
