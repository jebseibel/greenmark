...
public class DVDatavault {
     ...
     *
     * @param dvTag The DVDatavault Tag pointer to the keys you wish to extract
     * @return Vector
     */
     ...
     *
     * @param dvTag The DVDatavault Tag pointer to the values you wish to extract
     * @return Vector
     */
     ...
     * values.
     *
     * @param dvTagPrefix - the DVDatavault prefix you wish to add to the output.
     ...
     *
     * @param tag a valid DVDatavaultTag.
     * @return gets the referenced objects.
     */
    public final Object get(String tag) {
        try {
            Object o = DVDatavault._getOrDelete(this.DATA, tag, DVDatavault.GET);
            if (o != null) {
                return (o);
            }
        } catch (Exception e) {
     ...
     *
     * @param parameter the HTTP parameter to get.
    ...
    public final String getHttpParam(String parameter) {
        ...
        String sb = DVDatavaultTag.TAG_ID +
                DVDatavaultTag.TAG_DELIM_CHAR +
                "HTTP" +
                DVDatavaultTag.LIST_DELIM_CHAR +
                "PARAM" +
                DVDatavaultTag.LIST_DELIM_CHAR +
                parameter;
        // extract and return the parameter
        return (this.getString(sb));
    }
     ...
     *
     * @param dv DVDatavault The DVDatavault to merge.
     */
     ...
     * all merged values.
     *
     * @param dv      the DVDatavault to merge.
     * @param tagRoot the root DVDatavault Tag to be applied to all values in the DVDatavault that is being merged in.
     */
     ...
     *
     * @param tag   a valid DVDatavaultTag.
     * @param value the Object that is to be stored.
     ...
     * ************************************************************************ Add an Object to the DVDatavault.
     *
     * @param tag   a valid DVDatavaultTag Object.
     * @param value the Object that is to be stored.
     * @return true it the set executed properly, false if not.
     */
     ...
     * ************************************************************************ Add a Hashtable to the DVDatavault.
     *
     * @param tag   a valid DVDatavaultTag tag.
     * @param value the Hashtable to be added.
     * @return true it the set executed properly, false if not.
     */
     ...
     * ************************************************************************ /** Return an XML version of the DataVault.
     *
     * @param tabelem Tab element to add to output.
     * @param endline End of line element to add to output.
     * @return A StringBuffer containing the XML.
     */
    ...
    public final StringBuffer dump() {
        String start = ">START: DVDatavaultDump: all\n";
        String end = ">END: DVDatavaultDump: all\n";
        String prefix = ">\t";
        String suffix = "";
    ...
    public final StringBuffer dumpHTML() {
        String start = "<TABLE><TR><TD><B>START: DVDatavaultDump: all</B></TD></TR>\n";
        String end = "<TR><TD><B>END: DVDatavaultDump: all</B></TD></TR>\n</TABLE>\n";
        String prefix = "<TR><TD>&nbsp;&nbsp;&nbsp;";
        String suffix = "</TD></TR>";
        return (DVDatavaultFactory.dump(this, start, end, prefix, suffix));
    }
    ...
    public final StringBuffer dump(String tag) {
        String start = ">START: DVDatavaultDump: path at: " + tag + "\n";
        String end = ">END: DVDatavaultDump: path at: " + tag + "\n";
        String prefix = ">\t";
        String suffix = "";
    ...
    public final StringBuffer dumpHTML(String tag) {
        String start = "<TABLE><TR><TD><B>START: DVDatavaultDump: path at: " + tag + "</B></TD></TR>\n";
        String end = "<TR><TD><B>END: DVDatavaultDump: path at: " + tag + "</B></TD></TR>\n</TABLE>\n";
        String prefix = "<TR><TD>&nbsp;&nbsp;&nbsp;";
        String suffix = "</TD></TR>";
        return (DVDatavaultFactory.dump(this, tag, start, end, prefix, suffix));
    }
