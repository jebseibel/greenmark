...
public class UTXmlUtils {
	 ...
	 * <p>
	 * 
	 * @param <CODE>xmlTag</CODE>
	 *            - The xml tag to extract.
	 * @param <CODE>xmldata</CODE>
	 *            - The xml code to extract it from.
	 */
	 ...
	 * @param <CODE>xmldata</CODE>
	 *            - The xml code to extract it from.
	 * @param <CODEintStartPosition</CODE
	 *            - starting location
	 */
	 ...
	 *
	 * @param xmldata
	 *            - the xml data to be acted upon.
	 * @param xmltag
	 *            - the xml tag nodes to pull
	 * @param xmlname
	 *            - the name to use as a node
	 * @return
	 */
	...
	public static Vector getNodesToVector(String xml) {
		...
		try {
			...
			for (int marker = 0; marker != -1; marker = xml.indexOf("<", intTagBackClose + 1)) {
				...
				int intTagBackStart = xml.indexOf("</".concat(String.valueOf(tagg)), intTagEnd);
	...
	*/
	 ...
	 * 
	 * @param <CODE>xmldata</CODE>
	 *            - The xml code to extract elements from.
	 */
	...
	*/
	 ...
	 * @param <CODE>xmlTag</CODE>
	 *            - The xml tag to extract.
	 * @param <CODE>xmlPath</CODE>
	 *            - The xpath to the data element
	 */
