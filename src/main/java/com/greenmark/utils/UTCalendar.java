...
//	}
    ...
    private void parseJavaDate() {
        ...
        try {
            ...
            day_i = Integer.parseInt(formattedDate.substring(6));
...
//		trace.out( thismethod );
    ...
    public final String formatDateDisplay(String delimiter) {
        ...
        {
            return getMonth() + delimiter + getDay() + delimiter + getYear();
        }
    }
    ...
    public String formatFileDate() {
        try {
            if (isNull()) {
                ...
                return getYear() + "_" + monthString + "_" + dayString;
            }
        } catch (Exception ex) {
    ...
    public String formatYearFirstDate() {
        if (isNull()) {
            return "NULL";
        } else {  // Pad month values with zero to help filenames stay sorted correctly.
            ...
            return getYear() + "_" + monthStr + "_" + dayStr;
        }
    }
    ...
    public final boolean isNull() {
        return (calendar == null) || (getYear() == 9999) || (getYear() == 9998);
    }
    ...
    public final boolean isEqualInCalendarDate(UTCalendar inCal) {
        if ((getYear() < inCal.getYear()) || (getYear() > inCal.getYear()))
            ...
            return false;
        else return (getDay() >= inCal.getDay()) && (getDay() <= inCal.getDay());
    }
    ...
    public final boolean isBeforeInCalendarDate(UTCalendar inCal) {
        if (getYear() < inCal.getYear())
            ...
            return false;
        else return getDay() < inCal.getDay();
    }
