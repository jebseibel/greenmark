...
public class TimerManager {
     ...
     *
     * @param <CODE>label</CODE> String value of the timer to start.
     */
     ...
     *
     * @param <CODE>label</CODE> String value of the timer to end.
     */
     ...
     *
     * @param <CODE>label</CODE> Label of the timer.
     */
