...
public class Timer {
	...
	// error messages
	private static final String MSG_CURRENT = new String("Currently timing");
	private static final String MSG_NOTSTARTED = new String("Timer not started");
	private static final String MSG_INVALID = new String("Timer invalid");
	private static final String MSG_NOERROR = new String("");
	...
	public String getErrorMessage() {
		...
		// be returned
		Long ms = new Long(getTimerResult());
		switch (ms.intValue()) {
	 ...
	 *            int value of the timer to start.
	 */
	public void start() {
