...
public class Trace {
    ...
    private static final String ENTRY_STRING = "---ENTERING: ";
    ...
    public final String getHtmlString() {
        ...
        if (!msgIter.hasNext()) // There are no messages, return blank space.
            return "&nbsp;";
    ...
    public void addListener(TraceMessageListener listener) {
        ...
        if (!this.listeners.contains(listener)) // Don't keep adding them if they're there.
            listeners.add(listener);
    }

    public void removeListener(TraceMessageListener listener) {
        // Only try to remove them if they're there.
     ...
     *
     * @param <code>line</code> - a string object to be added
    ...
    public boolean isLevelModel() {
        ...
        if ((ApplicationDataContext.isHistoricalDatafeed()) && (!saveTraceMessagesToFile))
            return false;

        if (!messageOn) // We're not logging messages if the user turned off all messaging.
            return false;

        return this.loglevel <= LOGLEVEL_MODEL;
    }
    ...
    public boolean isLevelAnalysis() {
        ...
        return this.loglevel <= LOGLEVEL_ANALYSIS;
    }
    ...
    public boolean isLevelSparse() {
        ...
        return this.loglevel <= LOGLEVEL_SW_SPARSE;
    }
    ...
    public boolean isLevelVerbose() {
        ...
        return this.loglevel <= LOGLEVEL_SW_VERBOSE;
    }
    ...
    public boolean isLevelFatal() {
        ...
        return this.loglevel <= LOGLEVEL_FATAL;
    }
     ...
     * <p>
     *
     * @param <CODE>location</CODE> - Where you are in the code.
     */
     ...
     * <p>
     *
     * @param <CODE>className</CODE>   - The name of the class
     * @param <CODE>classMethod</CODE> - The method of the class
     */
     ...
     * <p>
     *
     * @param <CODE>location</CODE> - The location of code you are exiting.
     */
     ...
     * <p>
     *
     * @param <CODE>timername</CODE> The name of the timer to start.
     ...
     * <p>
     *
     * @param <CODE>timername</CODE> The name of the timer to stop.
     * @see com.disney.dep.util.trace.Timer
     */
     ...
     *
     * @param loggerAlternate FileWriter
     */
