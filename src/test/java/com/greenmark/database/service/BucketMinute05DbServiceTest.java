...
@SpringBootTest
class BucketMinute05DbServiceTest {
    @Autowired
    private BucketMinute05DbService service;
    ...
    class CreateTests {
        ...
        void createdNew() throws Exception {
            ...
            BucketMinute05Db result = service.create(symbol, stockData);
    ...
    class UpdateTests {
        ...
        void updated() throws DatabaseUpdateFailureException, DatabaseRetrievalFailureException, DatabaseAccessException {
            ...
            //execute
            BucketMinute05Db result = service.update(symbol, stockData);
