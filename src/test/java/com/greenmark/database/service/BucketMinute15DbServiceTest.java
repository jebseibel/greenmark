...
@SpringBootTest
class BucketMinute15DbServiceTest {

    @Autowired
    private BucketMinute15DbService service;
    ...
    class CreateTests {
        ...
        void createdNew() throws Exception {
            ...
            BucketMinute15Db result = service.create(symbol, stockData);
    ...
    class UpdateTests {
        ...
        void updated() throws DatabaseUpdateFailureException, DatabaseRetrievalFailureException, DatabaseAccessException {
            ...
            //execute
            BucketMinute15Db result = service.update(symbol, stockData);
